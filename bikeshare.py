...
def get_filters():
    ...
    while True:
        month = input("Do you want a particular month? Type month name from January-June or type 'all'")
        month = month.lower()
    ...
    while True:
        day = input("Do you want see a particular day? Type day name or type 'all'")
        day = day.lower()
