...
def user_stats(df):
    ...
    print("Earliest: {}, most recent: {}, and most common year of birth: {}".format(earliest_birth, recent_birth, common_birth))
    print("\nThis took %s seconds." % (time.time() - start_time))
    print('-'*40)
...
def main():
    ...
    while True:
        ...
        try:
            ...
            print("No data has been found, please change parameters, exception details:\n{0}".format(e))
