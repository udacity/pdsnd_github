...
def get_filters():
    ...
    while True:
        month = input('\nPlease input the month you wish to filter by\nJanuary, February, March, April, May, June. You can type all if you wish to use all the months\n')
    ...
    while True:
        day = input('\nPlease input the day you wish to filter by\nMonday, Tuesday, Wedesday, Thursday, Friday, Saturday, Sunday. You can type all if you wish to use all the days\n')
        if day not in ('Monday', 'Tuesday', 'Wedesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'):
            print('Your input is wrong, make sure the spelling is correct. Please try again')
            continue
        else:
            break
